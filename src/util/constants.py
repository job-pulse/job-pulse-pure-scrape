ng_us_urls = [
    ...
    'https://raw.githubusercontent.com/AlanChen4/2024-SWE-New-Grad/main/README.md'
]
ng_us_output_filename = 'gitRepoPostings/ng_us_output.json'
...
intern_us_output_filename = 'gitRepoPostings/intern_us_output.json'
